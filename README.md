...
| Set a manual **split** hotkey instead | OBS's own **Settings → Hotkeys** → set **Split Recording File** — or skip OBS's hotkey entirely and use this app's own **Split Recording File** tray item instead (see [Optional: split recording files](#optional-split-recording-files)) |
